  ...
  useEffect(() => {
    const loadConfiguration = async () => {
      try {
        ...
        setError(`Failed to load configuration: ${err.message}. Using default values for now.`);
          ...
          {validationErrors.length > 0 && (
            <div className="mb-6 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-yellow-800 dark:text-yellow-200">Please fix the following errors:</p>
            ...
            <section>
              <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-medium text-gray-900 dark:text-white">Coin System</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updateFormField('dailyFreeCoin', Number(e.target.value))}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updateFormField('emojiPinPrice', Number(e.target.value))}
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white"
                    />
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">Post Rules</h3>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateFormField('postVisibilityDuration', Number(e.target.value))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white"
                      />
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateFormField('dailyFreePostLimit', Number(e.target.value))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white"
                      />
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">Report Thresholds</h3>
                    <div className="p-2 rounded-full bg-red-100 dark:bg-red-900">
                      <img className="w-5 h-5" src="/icons/reports.png" alt="Flag Icon" style={{ filter: 'invert(17%) sepia(100%) saturate(7500%) hue-rotate(0deg) brightness(100%) contrast(100%)' }} />
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3 p-3 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                      ...
                      <span className="text-sm font-medium text-green-800 dark:text-green-200 flex-1">Normal</span>
                      <input
                        type="number"
                        min="1"
                        value={formData.reportThresholds.normal}
                        onChange={(e) => updateFormField('reportThresholds', { ...formData.reportThresholds, normal: Number(e.target.value) })}
                    ...
                    <div className="flex items-center space-x-3 p-3 rounded-lg bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800">
                      ...
                      <span className="text-sm font-medium text-yellow-800 dark:text-yellow-200 flex-1">Warning</span>
                      <input
                        type="number"
                        min="1"
                        value={formData.reportThresholds.warning}
                        onChange={(e) => updateFormField('reportThresholds', { ...formData.reportThresholds, warning: Number(e.target.value) })}
                    ...
                    <div className="flex items-center space-x-3 p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border-2 border-red-300 dark:border-red-700 shadow-sm">
                      ...
                      <span className="text-sm font-semibold text-red-800 dark:text-red-200 flex-1">Urgent Review</span>
                      <input
                        type="number"
                        min="1"
