...
import { Report, REPORT_STATUS, USER_STATUS, POST_STATUS } from '@/types/export';
import { User } from '@/types';
import { fetchUserById, incrementUserWarningCount, updateUserStatus } from '@/lib/firestore/users';
import { updatePostStatus, updatePostWarningStatus } from '@/lib/firestore/posts';
import { updateReportStatus, resolveReportsByPostId } from '@/lib/firestore/reports';
        ...
        <div className="p-6 space-y-6 flex-1 overflow-y-auto">
          ...
          <div className="space-y-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            <button
              ...
              disabled={actionCompleted || processing || report.status !== REPORT_STATUS.PENDING}
            ...
            <button
              ...
              disabled={reportDismissed || dismissingReport || report.status !== 'pending'}
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
                    Are you sure you want to <strong>remove the post</strong> and <strong>warn the user {report.reported.name}</strong>?
                  </p>
