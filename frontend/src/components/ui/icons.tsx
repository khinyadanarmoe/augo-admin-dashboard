...
export const BanIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const UnbanIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="m19.07 4.93-14.14 14.14"
    />
  </svg>
);

export const SuspendIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const UnsuspendIcon: React.FC<IconProps> = ({
  className = "w-4 h-4",
}) => (
  <svg
    className={className}
...
export const WarnIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const UserIcon: React.FC<IconProps> = ({ className = "w-12 h-12" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const ThumbsUpIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2v0a2 2 0 00-2 2v6.5"
    />
  </svg>
);
...
export const ThumbsDownIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M10 14H5.236a2 2 0 01-1.789-2.894l3.5-7A2 2 0 018.736 3h4.018c.163 0 .326.02.485.06L17 4m-7 10v2a2 2 0 002 2v0a2 2 0 002-2v-6.5"
    />
  </svg>
);
