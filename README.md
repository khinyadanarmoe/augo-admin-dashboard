...
- **Report Handling** - Process user reports with status tracking (pending/resolved/dismissed)
- **Announcer Approvals** - Manage announcer applications and permissions
- **Announcement System** - Create and schedule community announcements
- **Real-time Notifications** - Send warnings, bans, and alerts to users
